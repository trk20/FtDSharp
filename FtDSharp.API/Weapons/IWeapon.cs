...
public interface IWeapon : IBlock, IWeaponControl
{
    ...
    /// <summary>
    /// Whether the weapon can fire (OnTarget AND IsReady) under <see cref="FireOptions.Default"/>
    /// (from last Track/AimAt call this frame).
    /// Returns false if no aim/track has been performed this frame, if no controlling LWC exists,
    /// or if AI weapon firing is Off.
    /// </summary>
    bool CanFire { get; }
